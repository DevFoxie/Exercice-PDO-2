        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link text-white " href="enregistrement-patient.php">Données patients</a>
                </div>
            </div>
        </div>
    </nav>

    <a href="ajout-patient.php">Vers le formulaire pour les nouvelles entrées</a>
    <a href="enregistrement-patient.php">Données patients</a>
